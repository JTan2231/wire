    ...
    pub fn new(
        ...
        let token_mapping_filepath = match token_mapping_filepath {
            ...
            None => {
                ...
                let token_mapping_filepath = &path.join("o200k_base.tiktoken");
                ...
                token_mapping_filepath.to_path_buf()
            }
        };

        let contents = match std::fs::read_to_string(token_mapping_filepath.clone()) {
            Ok(c) => c,
            Err(e) => {
                println!("error reading tokenizer file: {}", e);
                return Err(e);
            }
        };
